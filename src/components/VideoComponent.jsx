...
const VideoComponent = () => {
  return (
    <div className='h-[calc(100vh-120px)] w-screen relative'>
        ...
        <div className='z-20 text-paper absolute bottom-[17%] text-[3rem] select-none flex w-full flex-col lg:flex-row lg:justify-around lg:items-center'>
          <div className='flex flex-col lg:flex-row items-center justify-start lg:justify-around w-full gap-y-8'>
            ...
            <div className='px-10 w-full lg:w-fit'>
              <button className='w-full bg-secondaryLight border-4 rounded-2xl tracking-wide leading-7 border-paper px-20 py-4 text-primaryLight rounded-4xl text-[1.3rem] hover:bg-blackTrans hover:text-paper transition-all duration-300 uppercase font-bold'>Book Now</button>
            </div>
          </div>
        </div>
      </div>
