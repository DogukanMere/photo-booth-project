    ...
    <div className='w-screen min-h-[30rem] py-[8rem] pb-[10rem] bg-primaryLight relative'>
      <div className='grid grid-cols-1 lg:grid-cols-2 max-w-[1420px] mx-auto items-center justify-center px-10 gap-x-6 gap-y-6'>
        ...
        <div className='flex flex-col gap-y-5 items-center justify-center col-span-1'>
          <FeatureCard icon={<Tb360View className='text-[6rem] text-primaryLight self-center' />} text={`Capture Every Angle with Our Digital 360 Rotating Camera!`} />
          <FeatureCard icon={<MdOutlineSlowMotionVideo className='text-[6rem] text-primaryLight self-center' />} text={`Engage with Mesmerizing Slow Motion and Custom Overlay-Designed Video Moments!`} />
          <FeatureCard icon={<MdOfflineShare className='text-[6rem] text-primaryLight self-center' />} text={`Send Your Video Directly to Your Phone via Text/Email; Instantly Share on TikTok, Reels, and Beyond!`} />
        </div>
        {/* Iphone Video */}
